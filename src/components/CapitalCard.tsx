  ...
  return <Card className="p-6 mb-8 bg-primary-gradient text-primary-foreground border-0 shadow-lg">
      <div className="flex justify-between items-start">
        <div className="space-y-3">
          ...
          <Button variant="secondary" className="bg-white/20 text-primary-foreground border-white/30 hover:bg-white/30 backdrop-blur-sm" onClick={onStakeClick}>
            Stake For Rewards
          </Button>
        </div>
        <div className="text-right space-y-3">
          <div>
            ...
            <p className="text-sm opacity-90">$BORE Tokens Available</p>
          </div>
